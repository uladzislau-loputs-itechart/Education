...
namespace MoneyManager
{
    public static class DataToDB
    {
        public static void Load(Context context)
        {
            ...
            new Transaction{CategoryId = 6, Amount = 400, AssetId = 1, Comment = null, Date = DateTime.Now},
            ...
            new Transaction{CategoryId = 13, Amount = 140, AssetId = 20, Comment = null, Date = DateTime.Now},
